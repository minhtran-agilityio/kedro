...
# flight_delay_predictions documentation build
...
from flight_delay_predictions import __version__ as release

# -- Project information -----------------------------------------------------

project = "flight_delay_predictions"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "flight_delay_predictionsdoc"
...
latex_documents = [
    (
        master_doc,
        "flight_delay_predictions.tex",
        "flight_delay_predictions Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "flight_delay_predictions",
        "Project flight_delay_predictions codebase.",
        "Data-Science",
    )
]
